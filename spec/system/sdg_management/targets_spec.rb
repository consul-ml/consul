...
describe "Targets" do
  ...
  describe "Index" do
    ...
    scenario "Show targets grouped by goal and sorted asc by code" do
      ...
      expect(goal_8.title).to appear_before(goal_8_target_2.official_title)
      expect(goal_8_target_2.official_title).to appear_before(goal_8_target_10.official_title)
      expect(goal_8_target_10.official_title).to appear_before(goal_16.title)
      expect(goal_16.title).to appear_before(goal_16_target_10.official_title)
      expect(goal_16_target_10.official_title).to appear_before(goal_16_target_A.official_title)
    end
  end
end
